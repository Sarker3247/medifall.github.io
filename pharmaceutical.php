...
if(isset($_REQUEST['submit']))
{
	...
	$date = $_REQUEST['date'];
        $sql="INSERT into  pharma(pharm_id,PharmaName,email,area,upzilla,district,medicine_name,quantity,phone,daate) values('','$pharma','$email','$area','$upzilla','$district','$medicine','$quantity','$phone','$date')";
	...
	<div class="container">
		...
		<div class="container col-md-5">
			<form class="form-group border border-info p-4 mt-5 mb-5" method="POST" action="" id="form">
				...
				<label for="user" class="mt-3 text-secondary"><i class="far fa-user pr-2 text-secondary"></i>Pharmaceutical Name</label>
				<input type="user" name="pharma" class="form-control" required>

				<label for="email" class="text-secondary mt-3"><i class="far fa-envelope pr-2 text-secondary"></i>Email</label>
				<input type="email" name="email" class="form-control" required>

				<label for="area" class="text-secondary mt-3"><i class="fas fa-map-pin pr-2 text-secondary"></i>Area</label>
				<input type="text" name="area" class="form-control" required>

				<div class="row">
					<div class="col-lg-6">
					<label for="upzilla" class="text-secondary mt-3"><i class="fas fa-location-arrow pr-2 text-secondary"></i>Upzilla</label>
				...
				<div class="row">
					...
					<div class="col-lg-6">
					<label for="medicine"class="mt-3 text-secondary"><i class="fas fa-sort-amount-up-alt pr-2 text-secondary"></i>Quantity</label>
